...
const CreateSpacePage = () => {
  ...
  return (
    <div className="bg-base-100 text-base-content py-10">
      <Container>
        <h1 className="font-heading text-4xl text-center text-base-content mb-10">
          Create New Ordering Space
        </h1>

        <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-8 p-6 bg-white shadow-lg rounded-xl">
          <SpaceDetailsForm
            spaceName={spaceName}
          ...
          <div className="bg-base-100 shadow-sm p-6 rounded-xl">
            <h2 className="font-heading text-2xl text-base-content mb-6">Menu Setup</h2>
            <MenuSetupTabs
